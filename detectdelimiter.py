...
def computeoccurence(lignes, ddelimiters):
    """
    Adds to the dictionary (dico) the number of each predefined delimiter for the first 5 lines. 

    :param lignes: Recovery of the first 5 lines of the file 
    :param ddelimiters: Retrieves the list of defined delimiters 
    """
...
def getautodelimiter(filename, ddelimiters):
    ...
    :param ddelimiters: List of predefined delimiters
    """
