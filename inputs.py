...
def inputscommandline(headers):
    ...
    # return dfilter dictionnary, each column will have at least cselect and cregex entry, and csort if asort is not null for the column.
    # return asort array, will contain each columns to sort
